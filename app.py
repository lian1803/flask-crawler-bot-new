        ...
        return [
            {
                "action": "message",
                "label": "📅 강화",
                "messageText": "강화된_QA_데이터"
            },
            {
                "action": "message",
                "label": "📋 원본",
                "messageText": "원본_QA_데이터"
            },
            {
                "action": "message",
                "label": "🍽️ 급식",
        ...
        return [
            {
                "action": "message",
                "label": "⬅️ 뒤로가기",
                "messageText": "초등학교" if "초등" in category or category in ["강화된_QA_데이터", "원본_QA_데이터", "급식정보", "더보기", "방과후", "상담문의"] else "유치원"
            }
        ]
...
def webhook():
    ...
    try:
        ...
        special_responses = [
            # 급식 관련 (날짜별 메뉴 형태로 유지)
            "오늘 급식 메뉴 알려줘", "이번주 급식 메뉴 알려줘", "오늘의 급식은?"
        ]
