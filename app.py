...
def webhook():
    ...
    try:
        ...
        # 초등학교 세부 카테고리 확인
        elif user_message in ["학사일정", "급식정보", "방과후", "상담문의", "학교시설", "등하교교통", "서류증명서", "교과서정보", "시간일정", "보건건강", "체험학습", "방학휴가"]:
            quick_replies_category = user_message
        ...
        special_responses = [
            ...
            "학교시설", "등하교", "보건실", "운동시설", "도서관", "컴퓨터실", "음악실", "미술실",
            "등교버스", "픽드롭", "주차장", "재학증명서", "생활기록부", "결석신고서", "체험학습신고서",
            "교과서 어디서 살 수 있어요?", "교과서 출판사", "도서대출", "하교시간", "수업시간", "단축수업",
            "질병결석", "감염병결석", "체험학습", "체험학습보고서", "교외체험학습", "방학일정", "방학식", "경조사휴가",
            # 유치원 관련
